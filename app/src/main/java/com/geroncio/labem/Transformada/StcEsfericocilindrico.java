...
import com.geroncio.labem.Transformada.Simplify.SimplifyEsfericoCilindrico;
...
public class StcEsfericocilindrico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stc_esfericocilindrico);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "StcEsfericocilindrico.class";
                    ...
                    try {
                        ...
                        if (processx == null || processy == null || processz == null){
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                String inforesult = "<b>U(ᵨ,ᵩ,z)</b> = "+ df.format(p1 * Math.sin(p2))
                                        +"<b>âᵨ</b> + ("+String.valueOf(df.format(p3))+"rad)<b>âᵩ</b> + "
                                        + df.format(p1 * Math.cos(p2))+"<b>âz</b>";
                                ...
                                infoM.setText(Html.fromHtml("<b>U(r,Ɵ,ᵩ)</b> = (" + String.valueOf(df.format(p1)).replace(",", ".") + " , " + String.valueOf(df.format(p2)).replace(",", ".") + " , " + String.valueOf(df.format(p3)).replace(",", ".") + ")" +
                                        "<br>" +
                                        "<br> .. ᵨ = r*sin(Ɵ) , ᵩ = ᵩ" +
                                        "<br>" +
                                        "<br> .. z = r*cos(Ɵ)" +
                                        "<br>" +
                                        "<br>" +
                                        "<br><b>Ü(ᵨ,ᵩ,z)</b> = (ᵨ,ᵩ,z)" +
                                        "<br>" +
                                        "<br> .. ᵨ = " + df.format(p1 * Math.sin(p2)) +
                                        "<br>" +
                                        "<br> .. ᵩ = " + df.format((p3)) +
                                        "<br>" +
                                        ...
                                        "<br>" +
                                        "<br>" +
                                        "<br><b>U(ᵨ,ᵩ,z)</b> = (" + df.format(p1 * Math.sin(p2))
                                        + "<b>âᵨ</b> + (" + String.valueOf(df.format(p3)) + "rad)<b>âᵩ</b> + "
                                        + df.format(p1 * Math.cos(p2)) + "<b>âz</b>"));
                            ...
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                SimplifyEsfericoCilindrico simplifyx = new SimplifyEsfericoCilindrico();
                                SimplifyEsfericoCilindrico simplifyy = new SimplifyEsfericoCilindrico();
                                SimplifyEsfericoCilindrico simplifyz = new SimplifyEsfericoCilindrico();

                                SimplifyEsfericoCilindrico simplifyreduzidax = new SimplifyEsfericoCilindrico();
                                SimplifyEsfericoCilindrico simplifyreduziday = new SimplifyEsfericoCilindrico();
                                SimplifyEsfericoCilindrico simplifyreduzidaz = new SimplifyEsfericoCilindrico();
                                ...
                                jaSimplify.setFunctionSimplificarEsfericilin("("+resultx+")*(ᵨ/sqrt(ᵨ^(2)+z^(2))) + ("+resulty+")*(z/sqrt(ᵨ^(2)+z^(2)))");
                                jaSimplify.jasimplificarEsfericilin();

                                String resultrefinadax = jaSimplify.getFunctionSimplificadaEsfericilin();

                                jaSimplify.setFunctionSimplificarEsfericilin(resultz);
                                jaSimplify.jasimplificarEsfericilin();

                                String resultrefinaday = jaSimplify.getFunctionSimplificadaEsfericilin();

                                jaSimplify.setFunctionSimplificarEsfericilin("("+resultx+")*(z/sqrt(ᵨ^(2)+z^(2))) - ("+resulty+")*(ᵨ/sqrt(ᵨ^(2)+z^(2)))");
                                jaSimplify.jasimplificarEsfericilin();

                                String resultrefinadaz = jaSimplify.getFunctionSimplificadaEsfericilin();
                                ...
                                infoM.setText(Html.fromHtml("<b>U(r,Ɵ,ᵩ)</b> = " +
                                        "<br> .. ["+processx+"]<b>âr</b> +" +
                                        "<br> .. ["+processy+"]<b>âƟ</b> +" +
                                        "<br> .. ["+processz+"]<b>âᵩ</b>" +
                                        "<br>" +
                                        "<br> .. r = √(ᵨ<sup>2</sup>+z<sup>2</sup>) ou r = ᵨ/sin(Ɵ)" +
                                        "<br> .. Ɵ = atan(ᵨ/z)" +
                                        "<br> .. ᵩ = ᵩ" +
                                        "<br>" +
                                        "<br><b>U(r,Ɵ,ᵩ)</b> = "+
                                        "<br> .. ["+resultreduzidax+"]<b>âr</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultreduziday+"]<b>âƟ</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultreduzidaz+"]<b>âᵩ</b>" +
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>U(r,Ɵ,ᵩ)</b> = "+
                                        "<br> .. ["+resultx+"]<b>âr</b> +" +
                                        ...
                                        "<br>" +
                                        "<br>" +
                                        "<br> . <b>âr</b> = sin(Ɵ)<b>âᵨ</b> + cos(Ɵ)<b>âz</b> " +
                                        "<br>"  +
                                        "<br> . <b>âƟ</b> = cos(Ɵ)<b>âᵨ</b> - sin(Ɵ)<b>âz</b>" +
                                        "<br>"+
                                        "<br> . <b>âᵩ</b> = <b>aᵩ</b>"+
                                        "<br>" +
                                        "<br>" +
                                        "<br> .. sin(Ɵ) = ᵨ/√(ᵨ<sup>2</sup>+z<sup>2</sup>)" +
                                        "<br>" +
                                        "<br> .. cos(Ɵ) = z/√(ᵨ<sup>2</sup>+z<sup>2</sup>)" +
                                        "<br> " +
                                        "<br>" +
                                        "<br><b>U(ᵨ,ᵩ,z)</b> = " +
                                        "<br>"+
                                ...
                                String inforesult = "<b>U(ᵨ,ᵩ,z)</b> = "+ df.format(p1 * Math.sin(p2))
                                        +"<b>âᵨ</b> + ("+String.valueOf(df.format(p3)).replace(",",".")+"rad)<b>âᵩ</b> + "
                                        + df.format(p1 * Math.cos(p2))+"<b>âz</b>";
                                ...
                                infoM.setText(Html.fromHtml("<b>Ü(r,Ɵ,ᵩ)</b> = (" + String.valueOf(df.format(p1)).replace(",", ".") + " , " + String.valueOf(df.format(p2)).replace(",", ".") + " , " + String.valueOf(df.format(p3)).replace(",", ".") + ")" +
                                        "<br>" +
                                        "<br> .. ᵨ = r*sin(Ɵ) , ᵩ = ᵩ" +
                                        "<br>" +
                                        "<br> .. z = r*cos(Ɵ)" +
