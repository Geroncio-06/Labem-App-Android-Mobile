...
import com.geroncio.labem.Transformada.Simplify.SimplifyCilindricoCartesiano;
...
public class StcCilindricocartesiano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stc_cilindricocartesiano);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "StcCilindricocartesiano.class";
                    ...
                    try {
                        ...
                        if (processx == null || processy == null || processz == null){
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                String inforesult = "<b>U(x,y,z)</b> = "+ df.format(p1 * Math.cos(p2))
                                        +"<b>âx</b> + "+ df.format(p1 * Math.sin(p2))+"<b>ây</b> + " + df.format(p3) +"<b>âz</b>";
                                ...
                                infoM.setText(Html.fromHtml("<b>U(ᵨ,ᵩ,z)</b> = ("+String.valueOf(df.format(p1)).replace(",",".")+" , " +String.valueOf(df.format(p2)).replace(",",".")+" , " +String.valueOf(df.format(p3)).replace(",",".")+")" +
                                        "<br>" +
                                        ...
                                        "<br>" +
                                        "<br> .. x = "+ df.format(p1 * Math.cos(p2)).replace(",",".")+
                                        "<br>" +
                                        "<br> .. y = "+ df.format(p1 * Math.sin(p2)).replace(",",".")+
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>U(x,y,z)</b> = "+ df.format(p1 * Math.cos(p2))
                                        +"<b>âx</b> + "+ df.format(p1 * Math.sin(p2))+ "<b>ây</b> + " + df.format(p3) +"<b>âz</b>"));
                            ...
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                SimplifyCilindricoCartesiano simplifyx = new SimplifyCilindricoCartesiano();
                                SimplifyCilindricoCartesiano simplifyy = new SimplifyCilindricoCartesiano();
                                SimplifyCilindricoCartesiano simplifyz = new SimplifyCilindricoCartesiano();

                                SimplifyCilindricoCartesiano simplifyreduzidax = new SimplifyCilindricoCartesiano();
                                SimplifyCilindricoCartesiano simplifyreduziday = new SimplifyCilindricoCartesiano();
                                SimplifyCilindricoCartesiano simplifyreduzidaz = new SimplifyCilindricoCartesiano();
                                ...
                                jaSimplify.setFunctionSimplificarCilindricoCart("("+resultx+")*(x/sqrt(x^(2)+y^(2))) - ("+resulty+")*(y/sqrt(x^(2)+y^(2)))");
                                jaSimplify.jasimplificarCilindricoCart();

                                String resultrefinadax = jaSimplify.getFunctionSimplificadaCilindricoCart();

                                jaSimplify.setFunctionSimplificarCilindricoCart("("+resultx+")*(y/sqrt(x^(2)+y^(2))) + ("+resulty+")*(x/sqrt(x^(2)+y^(2)))");
                                jaSimplify.jasimplificarCilindricoCart();

                                String resultrefinaday = jaSimplify.getFunctionSimplificadaCilindricoCart();

                                jaSimplify.setFunctionSimplificarCilindricoCart(resultz);
                                jaSimplify.jasimplificarCilindricoCart();

                                String resultrefinadaz = jaSimplify.getFunctionSimplificadaCilindricoCart();
                                ...
                                info.setText(Html.fromHtml("<b>U(x,y,z)</b> = ["+resultrefinadax+"]<b>âx</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultrefinaday+"]<b>ây</b> +" +
                                        "<br>" +
                                ...
                                infoM.setText(Html.fromHtml("<b>U(ᵨ,ᵩ,z)</b> = " +
                                        ...
                                        "<br>" +
                                        "<br> .. cos(ᵩ) = x/√(x<sup>2</sup>+y<sup>2</sup>)  " +
                                        "<br> .. sin(ᵩ) = y/√(x<sup>2</sup>+y<sup>2</sup>)" +
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>U(ᵨ,ᵩ,z)</b> = "+
                                        ...
                                        "<br>" +
                                        "<br>" +
                                        "<br> .. <b>âᵨ</b> = cos(ᵩ)<b>âx</b> + sin(ᵩ)<b>ây</b>" +
                                        "<br> .. <b>âᵩ</b> = -sin(ᵩ)<b>âx</b> + cos(ᵩ)<b>ây</b>"+
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>U(x,y,z)</b> = "+
                                        "<br> .. [("+resultx+")*cos(ᵩ) - ("+resulty+")*sin(ᵩ)]<b>âx</b> +" +
                                        "<br>" +
                                        "<br> .. [("+resultx+")*sin(ᵩ) + ("+resulty+")*cos(ᵩ)]<b>ây</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultz+"]<b>âz</b>" +
                                        "<br>" +
                                        "<br>" +
                                        "<br><b>U(x,y,z)</b> = "+
                                        "<br> .. ["+resultrefinadax+"]<b>âx</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultrefinaday+"]<b>ây</b> +" +
                                        "<br>" +
                                        "<br> .. ["+resultrefinadaz+"]<b>âz</b>"));
                                ...
                                String inforesult = "<b>Ü(x,y,z)</b> = "+ df.format(p1 * Math.cos(p2))
                                        +"<b>âx</b> + "+ df.format(p1 * Math.sin(p2))+"<b>ây</b> + " + df.format(p3) +"<b>âz</b>";

                                info.setText(Html.fromHtml(inforesult));


                                infoM.setText(Html.fromHtml("<b>Ü(ᵨ,ᵩ,z)</b> = ("+String.valueOf(df.format(p1)).replace(",",".")+" , " +String.valueOf(df.format(p2)).replace(",",".")+" , " +String.valueOf(df.format(p3)).replace(",",".")+")" +
                                        "<br>" +
                                        "<br> .. x = ᵨ*cos(ᵩ) , y = ᵨ*sin(ᵩ)" +
                                        "<br>" +
                                        "<br>" +
                                        "<br><b>Ü(x,y,z)</b> = (x, y, z)" +
                                        "<br>" +
                                        "<br> .. x = "+ df.format(p1 * Math.cos(p2)).replace(",",".")+
                                        "<br>" +
                                        "<br> .. y = "+ df.format(p1 * Math.sin(p2)).replace(",",".")+
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>Ü(x,y,z)</b> = "+ df.format(p1 * Math.cos(p2))
                                        +"<b>âx</b> + "+ df.format(p1 * Math.sin(p2))+ "<b>ây</b> + " +String.valueOf(df.format(p3))+"<b>âz</b>"));
