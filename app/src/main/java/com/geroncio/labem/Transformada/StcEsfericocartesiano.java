                    ...
                    try {
                        ...
                        if (processx == null || processy == null || processz == null){
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                String inforesult = "<b>Ü(x,y,z)</b> = "+ df.format(p1 * Math.sin(p2) * Math.cos(p3))
                                        +"<b>âx</b> + "+ df.format(p1 * Math.sin(p2) * Math.sin(p3))+"<b>ây</b> + "
                            ...
                            if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                                ...
                                infoM.setText(Html.fromHtml("<b>U(r,Ɵ,ᵩ)</b> = " +
                                        ...
                                        "<br> ....... + cos(Ɵ)<b>âz</b>" +
                                        "<br>"  +
                                        "<br> . <b>âƟ</b> = cos(Ɵ)*cos(ᵩ)<b>âx</b> + cos(Ɵ)*sin(ᵩ)<b>ây</b> " +
                                        "<br> ....... - sin(Ɵ)<b>âz</b>" +
                                        "<br>"+
                                        "<br> . <b>âᵩ</b> = -sin(ᵩ)<b>âx</b> + cos(ᵩ)<b>ây</b>"+
                                        "<br>" +
                                        "<br>" +
                                        "<br> .. sin(Ɵ) = √(x<sup>2</sup>+y<sup>2</sup>)/√(x<sup>2</sup>+y<sup>2</sup>+" +
                                        "<br> ......... z<sup>2</sup>) " +
                                        "<br>" +
                                        "<br> .. cos(Ɵ) = z/√(x<sup>2</sup>+y<sup>2</sup>+z<sup>2</sup>)" +
                                        "<br>" +
                                ...
                                info.setText(Html.fromHtml("<b>Ü(x,y,z)</b> = ("+ df.format(p1 * Math.sin(p2) * Math.cos(p3)).replace(",",".")
                                ...
                                infoM.setText(Html.fromHtml("<b>Ü(r,Ɵ,ᵩ)</b> = ("+String.valueOf(df.format(p1)).replace(",",".")+" , " +String.valueOf(df.format(p2)).replace(",",".")+" , " +String.valueOf(df.format(p3)).replace(",",".")+")" +
                                        ...
                                        "<br>" +
                                        "<br>"+
                                        "<br><b>Ü(x,y,z)</b> = ("+ df.format(p1 * Math.sin(p2) * Math.cos(p3)).replace(",",".")
                                        +" , "+ df.format(p1 * Math.sin(p2) * Math.sin(p3)).replace(",",".")+" , "
                                        + df.format(p1 * Math.cos(p2)).replace(",",".")+")"));
