...
public class CvDivergentecartesiano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cv_divergentecartesiano);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "CvDivergentecartesiano.class";
                    ...
                    if (processx == null || processy == null || processz == null){
                        ...
                        if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(x,y,z)</b> = "+processx+"<b>âx</b> +" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇.<b>Ä</b> = (∂<b>Ä</b>/∂x) + (∂<b>Ä</b>/∂y) + (∂<b>Ä</b>/∂z)" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> ∇.<b>Ä</b> = " +
                                    "<br> .. (∂/∂x)["+processx+"] + " +
                            ...
                            der.derivar();
                            derY.setFunctionDerivar(processy);
                            derY.derivar();
                            derZ.setFunctionDerivar(processz);
                            derZ.derivar();
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(x,y,z)</b> = "+processx+"<b>âx</b> +" +
                                    ...
                                    "<br> na resposta do divergente ∇.<b>Ä</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇.<b>Ä</b> = "+resultado));
