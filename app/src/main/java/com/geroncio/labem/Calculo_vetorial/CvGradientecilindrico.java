...
public class CvGradientecilindrico extends AppCompatActivity {
    ...
    private  void Teclado(){
        ...
        btnx.setOnClickListener(view -> {
            process = txtimput.getText().toString() + "ᵨ";
            txtimput.setText(process);
                ...
                try {
                    ...
                    if (process == null){
                        ...
                        if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                            ...
                            process = process.replace("ᵨ","x");
                            process = process.replace("ᵩ","y");
                            ...
                            processarSaidaDerivada = processarSaidaDerivada.replace("x","ᵨ");
                            processarSaidaDerivada = processarSaidaDerivada.replace("y","ᵩ");
                            ...
                            processarSaidaDerivadaY = processarSaidaDerivadaY.replace("x","ᵨ");
                            processarSaidaDerivadaY = processarSaidaDerivadaY.replace("y","ᵩ");
                            ...
                            processarSaidaDerivadaZ = processarSaidaDerivadaZ.replace("x","ᵨ");
                            processarSaidaDerivadaZ = processarSaidaDerivadaZ.replace("y","ᵩ");

                            process = process.replace("sqrt","√");
                            process = process.replace("x","ᵨ");
                            process = process.replace("y","ᵩ");

                            processarSaida = processarSaida.replace("sqrt","√");
                            processarSaidaY = processarSaidaY.replace("sqrt","√");
                            processarSaidaZ = processarSaidaZ.replace("sqrt","√");

                            info.setText(Html.fromHtml("<b>∇V</b> = [ "+processarSaidaDerivada+" ]<b>âᵨ</b>" +
                                    "<br>+ " +
                                    "<br> .. [ "+ processarSaidaDerivadaY+ " ]<b>âᵩ</b>" +
                                    "<br>+ " +
                                    "<br> .. [ "+processarSaidaDerivadaZ+" ]<b>âz</b>"
                            ));


                            infoM.setText(Html.fromHtml("V(ᵨ,ᵩ,z) = "+process+"" +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>∇V</b> = (∂V/∂ᵨ)<b>âᵨ</b> + (1/ᵨ)*(∂V/∂ᵩ)<b>âᵩ</b> + (∂V/∂z)<b>âz</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> <b>∇V</b> = " +
                                    "<br> .. (∂/∂ᵨ)["+process+"]<b>âᵨ</b> + " +
                                    "<br>" +
                                    "<br> .. (∂/∂ᵩ)["+process+"]*(1/ᵨ)<b>âᵩ</b> + " +
                                    "<br>" +
                                    "<br> .. (∂/∂z)["+process+"]<b>âz</b> " +
                                    "<br>" +
                                    "<br>" +
                                    ...
                                    "<br>+ " +
                                    "<br> .. [ "+ processarSaidaY+ " ]*(1/ᵨ)<b>âᵩ</b>" +
                                    "<br>+ " +
                                    "<br> .. [ "+processarSaidaZ+" ]<b>âz</b>"+
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>∇V</b> = [ "+processarSaidaDerivada+" ]<b>âᵨ</b>" +
                                    "<br>+ " +
                                    "<br> .. [ "+ processarSaidaDerivadaY+ " ]<b>âᵩ</b>" +
                                    "<br>+ " +
                                    "<br> .. [ "+processarSaidaDerivadaZ+" ]<b>âz</b>"
                            ...
                            saidaX = saidaX.replace("x","ᵨ");
                            saidaX = saidaX.replace("y","ᵩ");
                            ...
                            saidaY = saidaY.replace("x","ᵨ");
                            saidaY = saidaY.replace("y","ᵩ");
                            ...
                            saidaZ = saidaZ.replace("x","ᵨ");
                            saidaZ = saidaZ.replace("y","ᵩ");
                            ...
                            String inforesult = "<b>∇V</b> = "+ df.format(resultx) +"<b>âᵨ</b> + "
                                    + df.format(resulty) + "<b>âᵩ</b> + "+ df.format(resultz) +"<b>âz</b>";
                            ...
                            infoM.setText(Html.fromHtml("V(ᵨ,ᵩ,z) = "+process+"" +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>∇V</b> = (∂V/∂ᵨ)<b>âᵨ</b> + (1/ᵨ)*(∂V/∂ᵩ)<b>âᵩ</b> + " +
                                    "<br>(∂V/∂z)<b>âz</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> <b>∇V</b> = " +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>P</b> = "+ df.format(p1) +"<b>âᵨ</b> + "+ df.format(p2) +"rad <b>âᵩ</b> + "+ df.format(p3) +"<b>âz</b>" +
                                    "<br>" +
                                    "<br> Substituimos os valores de ᵨ, ᵩ e z do ponto <b>P</b>" +
                                    "<br> na resposta do gradiente ∇V" +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>∇V</b> = "+ df.format(resultx) +"<b>âᵨ</b> + "+ df.format(resulty) + "<b>âᵩ</b> + "+ df.format(resultz) +"<b>âz</b>"
                            ));
