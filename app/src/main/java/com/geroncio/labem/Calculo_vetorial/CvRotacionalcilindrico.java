...
public class CvRotacionalcilindrico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cv_rotacionalcilindrico);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "CvRotacionalcilindrico.class";
                ...
                try {
                    ...
                    if (processx == null || processy == null || processz == null){
                        ...
                        if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                            ...
                            info.setText(Html.fromHtml("∇xÄ = ["+ResultadoAX+"]<b>âᵨ</b> " +
                                    "<br> + " +
                            ...
                            info.setText(Html.fromHtml("∇x<b>Ä</b> = ["+resultadoAX+"]<b>âᵨ</b> + ["+resultadoAY+"]<b>âᵩ</b> + ["+resultadoAZ+"]<b>âz</b>"));
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(ᵨ,ᵩ,z)</b> = "+processx+"<b>âᵨ</b> +" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇x<b>Ä</b> = ["+resultadoAX+"]<b>âᵨ</b> + ["+resultadoAY+"]<b>âᵩ</b> + ["+resultadoAZ+"]<b>âz</b>"));
