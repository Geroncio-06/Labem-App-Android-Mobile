...
public class CvRotacionalcartesiano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cv_rotacionalcartesiano);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "CvRotacionalcartesiano.class";
                ...
                try {
                    ...
                    if (processx == null || processy == null || processz == null){
                        ...
                        if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                            ...
                            info.setText(Html.fromHtml("∇x<b>Ä</b> = ["+ResultadoAX+"]<b>âx</b> " +
                                    "<br> + " +
                            ...
                            info.setText(Html.fromHtml("∇x<b>Ä</b> = ["+resultadoAX+"]<b>âx</b> + ["+resultadoAY+"]<b>ây</b> + ["+resultadoAZ+"]<b>âz</b>"));
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(x,y,z)</b> = "+processx+"<b>âx</b> +" +
                                    ...
                                    "<br> .. ["+ResultadoAZ+"]<b>âz</b> " +
                                    "<br>" +
                                    "<br> Substituimos os valores de x, y e z do ponto P " +
                                    "<br> na resposta do rotacional ∇x<b>Ä</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇x<b>Ä</b> = ["+resultadoAX+"]<b>âx</b> + ["+resultadoAY+"]<b>ây</b> + ["+resultadoAZ+"]<b>âz</b>"
                            ));
