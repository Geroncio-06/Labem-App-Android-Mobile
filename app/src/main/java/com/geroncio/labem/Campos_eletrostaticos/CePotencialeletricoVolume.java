...
public class CePotencialeletricoVolume extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ce_potencialeletrico_volume);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "CePotencialeletricoVolume.class";
            ...
            new Handler().postDelayed(() -> {
                ...
                try {
                    ...
                    if (normar12 <= Double.parseDouble(raioesfera.getText().toString())){
                        ...
                        Double fcoulomb = (6*Math.PI*Math.pow(10,9)*pv*(3*Math.pow(raio,2) - Math.pow(normar12,2)));
                        ...
                        if (separar.contains("E")){
                            ...
                            info.setText(Html.fromHtml("<b>Ve</b> = "+String.valueOf(df2.format(resfcoulomb)).replace(",",".")+"*10^("+textoseparado[1]+" <b>âr</b> V" ));

                            infoM.setText(Html.fromHtml("Potencial elétrico de uma geometria esférica com o ponto de cálculo dentro do volume de carga" +
                                    "<br>" +
                                    "<br><b>Ve</b> = [1/(6*εo)]*(ᵨv)*[3*|R|<sup>2</sup> - |<b>r</b>|<sup>2</sup>] <b>âr</b>" +
                                    "<br>" +
                                    "<br> .. [1/(6*εo)] = 6π*10<sup>9</sup> N.m<sup>2</sup>/C<sup>2</sup>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br> [1/(6*εo)]*(ᵨv)*[3*|R|<sup>2</sup> - |<b>r</b>|<sup>2</sup>] = "+String.valueOf(df2.format(resfcoulomb)).replace(",",".")+"*10^("+textoseparado[1]+")"+
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ve</b> = "+String.valueOf(df2.format(resfcoulomb)).replace(",",".")+"*10^("+textoseparado[1]+" <b>âr</b> V"));
                            ...
                            info.setText(Html.fromHtml("<b>Ve</b> = " + sfcoulomb + " <b>âr</b> V" ));
                            ...
                            infoM.setText(Html.fromHtml("Potencial elétrico de uma geometria esférica com o ponto de cálculo dentro do volume de carga" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br>[1/(6*εo)]*(ᵨv)*[3*|R|<sup>2</sup> - |<b>r</b>|<sup>2</sup>] = " + sfcoulomb +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ve</b> = " + sfcoulomb + " <b>âr</b> V"));
                    ...
                    if (normar12 > Double.parseDouble(raioesfera.getText().toString())){
                        ...
                        Double fcoulomb = (12*Math.PI*Math.pow(10,9)*pv*Math.pow(raio,3))/(normar12);
                        ...
                        if (separar.contains("E")){
                            ...
                            infoM.setText(Html.fromHtml("Potencial elétrico de uma geometria esférica com o ponto de cálculo fora do volume de carga" +
                                    "<br>" +
                                    "<br>V2 = [1/(3*εo)]*ᵨv*(R<sup>3</sup>)*[1/|<b>r</b>|] <b>âr</b>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br> [1/(3*εo)]*ᵨv*(R<sup>3</sup>)*[1/|<b>r</b>|] =  = "+String.valueOf(df2.format(resfcoulomb)).replace(",",".")+"*10^("+textoseparado[1]+")"+
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ve</b> = "+String.valueOf(df2.format(resfcoulomb)).replace(",",".")+"*10^("+textoseparado[1]+" <b>âr</b> V"
                            ));
                            ...
                            infoM.setText(Html.fromHtml("Potencial elétrico de uma geometria esférica com o ponto de cálculo fora do volume de carga" +
                                    "<br>" +
                                    "<br><b>Ve</b> = [1/(3*εo)]*ᵨv*(R<sup>3</sup>)*[1/|<b>r</b>|] <b>âr</b>" +
                                    "<br>" +
                                    "<br> .. [1/(3*εo)] = 12π*10<sup>9</sup> N.m<sup>2</sup>/C<sup>2</sup>" +
                                    "<br> .. ᵨv = "+processx+" C/m<sup>3</sup>" +
                                    "<br> .. R = "+raioesfera.getText().toString()+ " m" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. [1/(3*εo)]*ᵨv*(R<sup>3</sup>)*[1/|<b>r</b>|] = "+sfcoulomb+
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ve</b> = "+sfcoulomb+" <b>âr</b> V"
                            ));
