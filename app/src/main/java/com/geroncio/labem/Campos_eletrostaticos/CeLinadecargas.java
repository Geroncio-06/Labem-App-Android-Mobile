                ...
                try {
                    ...
                    if (componentedl == null || p_7.getText().toString().isEmpty() || p_8.getText().toString().isEmpty()){
                        ...
                        if (componentedl.equals("dx")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresultw+"<b>âx</b> + "+eresulty+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"));

                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(4π*εo*r)]*ᵨl*{-[sin(α2)-sin(α1)]<b>âr</b>+" +
                                    "<br> ............ [cos(α2)-cos(α1)]<b>âx</b>}" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. [1/(4π*εo*r)]*ᵨl = "+eresult+
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresult+"*{-[sin(α2)-sin(α1)]<b>âr</b>+" +
                                    "<br> ............ [cos(α2)-cos(α1)]<b>âx</b>}" +
                                    "<br>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresult+"*["+mathap+"<b>âr</b>+"+mathcomponentedl+"<b>âx</b>]" +
                                    "<br>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë </b>= "+eresultw+"<b>âx</b> + "+eresulty+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"
                            ));
                        ...
                        if (componentedl.equals("dy")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresultw+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"));

                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(4π*εo*r)]*ᵨl*{-[sin(α2)-sin(α1)]<b>âr</b>+" +
                                    "<br> ............ [cos(α2)-cos(α1)]<b>ây</b>}" +
                                    "<br>" +
                                    "<br> .. 1/(4π*εo) = 9*10<sup>9</sup> N.m<sup>2</sup>/C<sup>2</sup>" +
                                    "<br> .. ᵨl = "+processx+" C/m" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresult+"*["+mathap+"<b>âr</b>+"+mathcomponentedl+"<b>ây</b>]" +
                                    "<br>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresultw+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"));
                        ...
                        if (componentedl.equals("dz")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresulty+"<b>ây</b> + "+eresultw+"<b>âz</b> V/m"));

                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(4π*εo*r)]*ᵨl*{-[sin(α2)-sin(α1)]<b>âr</b>+" +
                                    "<br> ............ [cos(α2)-cos(α1)]<b>âz</b>}" +
                                    "<br>" +
                                    "<br> .. 1/(4π*εo) = 9*10<sup>9</sup> N.m<sup>2</sup>/C<sup>2</sup>" +
                                    "<br> .. ᵨl = "+processx+" C/m" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresult+"*["+mathap+"<b>âr</b>+"+mathcomponentedl+"<b>âz</b>]" +
                                    "<br>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresulty+"<b>ây</b> + "+eresultw+"<b>âz</b> V/m"
                            ));
                ...
                try {
                    ...
                    if (componentedl == null){
                        ...
                        if (componentedl.equals("dx")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresulty+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"));

                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(2π*εo*r)]*ᵨl <b>âr</b>" +
                                    "<br>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. [1/(2π*εo*r)]*ᵨl = "+eresult+
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresult+"*<b>âr</b>" +
                                    "<br>" +
                                    "<br> .. <b>âr</b> = <b>R</b>/r = [1/√("+ df2.format(Math.pow(norma, 2)).replace(",",".")+")]*(" +String.valueOf(df2.format(Ry)).replace(",",".")+"<b>ây</b> + "+String.valueOf(df2.format(Rz)).replace(",",".")+"<b>âz</b>)" +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresulty+"<b>ây</b> + "+eresultz+"<b>âz</b> V/m"));
                        ...
                        if (componentedl.equals("dy")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresultz+"<b>âz</b> V/m"));
                            ...
                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(2π*εo*r)]*ᵨl <b>âr</b>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresultz+"<b>âz</b> V/m"
                            ));
                        ...
                        if (componentedl.equals("dz")){
                            ...
                            info.setText(Html.fromHtml("<b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresulty+"<b>ây</b> V/m"));
                            ...
                            infoM.setText(Html.fromHtml("<b>Ë</b> = [1/(2π*εo*r)]*ᵨl <b>âr</b>" +
                                    ...
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>Ë</b> = "+eresultx+"<b>âx</b> + "+eresulty+"<b>ây</b> V/m"
                            ));
