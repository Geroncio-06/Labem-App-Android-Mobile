...
public class AvVetordoispontos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_av_vetordoispontos);
    ...
    protected void Inicializate(){
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "AvVetordoispontos.class";
            i.putExtra("STRING_ACTIVITY", main);
            startActivity(i);
        });

        voltar.setOnClickListener(view -> {
            startActivity(new Intent(AvVetordoispontos.this, Algebra_vetorial.class));
            finish();
        });
        ...
        calcular.setOnClickListener(view -> {
            ...
            new Handler().postDelayed(() -> {
                ...
                try {
                    ...
                    String resultx = df.format(p2x - p1x);
                    String resulty = df.format(p2y - p1y);
                    String resultz = df.format(p2z - p1z);
                    String resultpassos = "<b>U</b> = [("+ df.format(p2x) +") - ("+ df.format(p1x) +")]<b>âx</b> + [("
                            + df.format(p2y) +") - ("+ df.format(p1y) +")]<b>ây</b> + [("
                            + df.format(p2z) +") - ("+ df.format(p1z) +")]<b>âz</b>" +
                            "<br>"+
                            "<br>"+
                            "<br><b>U</b> = "+resultx+"<b>âx</b> + "+resulty+"<b>ây</b> + "+resultz+"<b>âz</b> ";


                    infoM.setText(Html.fromHtml("<b>U</b> = "+resultx+"<b>âx</b> + "+resulty+"<b>ây</b> + "+resultz+"<b>âz</b> "));
