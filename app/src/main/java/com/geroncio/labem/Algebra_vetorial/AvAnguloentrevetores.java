...
public class AvAnguloentrevetores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_av_anguloentrevetores);
    ...
    protected void Inicializate(){
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "AvAnguloentrevetores.class";
            i.putExtra("STRING_ACTIVITY", main);
            startActivity(i);
        });

        voltar.setOnClickListener(view -> {
            startActivity(new Intent(AvAnguloentrevetores.this, Algebra_vetorial.class));
            finish();
        });
        ...
        calcular.setOnClickListener(view -> {
            ...
            new Handler().postDelayed(() -> {
                ...
                try {
                    ...
                    p2x = Double.parseDouble(p2_x.getText().toString());p2y = Double.parseDouble(p2_y.getText().toString()); p2z = Double.parseDouble(p2_z.getText().toString());


                    /**
                     * Variaveis locais tipo texto (String)*/

                    String result1 = df.format(p1x * p2x + p1y * p2y + p1z * p2z);
                    String result2 = df.format(Math.sqrt(Math.pow(p1x, 2) + Math.pow(p1y, 2) + Math.pow(p1z, 2)));
                    String result3 = df.format(Math.sqrt(Math.pow(p2x, 2) + Math.pow(p2y, 2) + Math.pow(p2z, 2)));

                    String result = df2.format(Math.acos((p1x * p2x + p1y * p2y + p1z * p2z) / (Math.sqrt(Math.pow(p1x, 2) + Math.pow(p1y, 2) + Math.pow(p1z, 2)) * Math.sqrt(Math.pow(p2x, 2) + Math.pow(p2y, 2) + Math.pow(p2z, 2)))));


                    String resultpassos = "<b>U</b>&middot<b>V</b> = |<b>U</b>||<b>V</b>|cosƟ" +
                            "<br>" +
                            "<br><b>U</b> = (x<sub>1</sub>, y<sub>1</sub>, z<sub>1</sub>) " +
                            "<br>" +
                            "<br> <b>V</b> = (x<sub>2</sub>, y<sub>2</sub>, z<sub>2</sub>)" +
                            "<br>" +
                            "<br><br>" +
                            "<br> <b>U&middot V</b> = x<sub>1</sub>*x<sub>2</sub> + y<sub>1</sub>*y<sub>2</sub> + z<sub>1</sub>*z<sub>2</sub>" +
                            "<br> <br> ..... = <b>"+ result1+"</b>"+
                            "<br>" +
                            "<br> <b>|U|</b> = √[(x<sub>1</sub><sup>2</sup>) + (y<sub>1</sub><sup>2</sup>) + (z<sub>1</sub><sup>2</sup>)]" +
                            "<br> <br> ..... = <b>"+ result2+"</b>"+
                            "<br>" +
                            ...
                            "<br>" +
                            "<br><br>" +
                            "<br><b>Ɵ</b> = cos<sup>-1</sup>( <b>U</b>&middot<b>V</b> / |<b>U</b>||<b>V</b>| )" +
                            "<br>" +
                            "<br><b>Ɵ</b> = cos<sup>-1</sup>("+df.format((p1x*p2x + p1y*p2y + p1z*p2z)/(Math.sqrt(Math.pow(p1x,2) + Math.pow(p1y,2) + Math.pow(p1z,2))*Math.sqrt(Math.pow(p2x,2) + Math.pow(p2y,2) + Math.pow(p2z,2))))+")" +
                            "<br>" +
                            "<br><b>Ɵ</b> = <b>"+result+"</b> rad";
                    ...
                    infoM.setText(Html.fromHtml("<b>Ɵ</b> = "+result +" rad ou "
                            +df.format((180/Math.PI)*Math.acos((p1x*p2x + p1y*p2y + p1z*p2z)/(Math.sqrt(Math.pow(p1x,2) + Math.pow(p1y,2) + Math.pow(p1z,2))
                            *Math.sqrt(Math.pow(p2x,2) + Math.pow(p2y,2) + Math.pow(p2z,2)))))+"°"));
