                ...
                try {
                    ...
                    String resultpassos =
                            "<b>U</b> = (x<sub>1</sub>, y<sub>1</sub>, z<sub>1</sub>) , <b>V</b> = (x<sub>2</sub>, y<sub>2</sub>, z<sub>2</sub>)"+
                                    "<br>"+
                            "<br><b>U</b>+<b>V</b> = (x<sub>1</sub>+x<sub>2</sub>)<b>âx</b> + (y<sub>1</sub>+y<sub>2</sub>)<b>ây</b> + (z<sub>1</sub>+z<sub>2</sub>)<b>âz</b>"+
                                    "<br>"+
                            "<br><b>U</b>+<b>V</b> = " +
                                    "<br>"+
                                    "<br>[("+df.format(p1x)+")+("+df.format(p2x) + ")]<b>âx</b> + [("+df.format(p1y)+")+("+df.format(p2y) + ")]<b>ây</b> + [("+df.format(p1z)+")+("+df.format(p2z) + ")]<b>âz</b> "+
                            "<br>" +
                                    "<br>" +
                            "<br><b>U</b>+<b>V</b> = "+result1+"<b>âx</b> + "+result2+"<b>ây</b> + "+result3+"<b>âz</b>";

                    resultpassos = resultpassos.replace("+ -","- ");



                    infoM.setText(Html.fromHtml("<b>U</b>+<b>V</b> = "+result1+"<b>âx</b> + "+result2+"<b>ây</b> + "+result3+"<b>âz</b>"));
