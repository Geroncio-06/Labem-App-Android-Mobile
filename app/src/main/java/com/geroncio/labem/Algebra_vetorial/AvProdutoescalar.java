...
public class AvProdutoescalar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_av_produtoescalar);
    ...
    protected void Inicializate(){
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "AvProdutoescalar.class";
            i.putExtra("STRING_ACTIVITY", main);
            startActivity(i);
        });

        voltar.setOnClickListener(view -> {
            startActivity(new Intent(AvProdutoescalar.this, Algebra_vetorial.class));
            finish();
        });
        ...
        calcular.setOnClickListener(view -> {
            ...
            new Handler().postDelayed(() -> {
                ...
                try {
                    ...
                    String result = df.format(p1x * p2x + p1y * p2y + p1z * p2z);
                    ...
                    String resultpassos =
                                    ...
                                    "<br><b>U &middot V</b> = x<sub>1</sub>*x<sub>2</sub> + y<sub>1</sub>*y<sub>2</sub> + z<sub>1</sub>*z<sub>2</sub>" +
                                            "<br>"+
                                    "<br><b>U &middot V</b> = " +
                                    "<br>[("+df.format(p1x)+")*("+df.format(p2x) + ")] + [("+df.format(p1y)+")*("+df.format(p2y) + ")] + [("+df.format(p1z)+")*("+df.format(p2z) + ")] "+
                                    "<br>"+
                                    "<br><b>U &middot V</b> = "+result;
                    ...
                    infoM.setText(Html.fromHtml("<b>U &middot V</b> = "+result));
