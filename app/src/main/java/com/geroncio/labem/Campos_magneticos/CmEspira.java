            ...
            new Handler().postDelayed(() -> {
                    ...
                    try{
                        ...
                        if (componentedl.equals("dx")){
                            ...
                            infoM.setText(Html.fromHtml("<b>H</b> = I*r<sup>2</sup>/{2*[r<sup>2</sup> + h<sup>2</sup>]<sup>3/2</sup>} <b>âx</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. dl = "+componentedl+" " +
                                    "<br>" +
                                    ...
                                    "<br> " +
                                    "<br> .. h é a distancia do centro da espira ao ponto calculado"+
                                    "<br> " +
                                    "<br> .. h = (Xp-Xe)" +
                                    "<br> .. h  = "+df.format(h)+" m"+
                                    "<br>"+
                        ...
                        if (componentedl.equals("dy")){
                            ...
                            infoM.setText(Html.fromHtml("<b>H</b> = I*r<sup>2</sup>/{2*[r<sup>2</sup> + h<sup>2</sup>]<sup>3/2</sup>} <b>ây</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. dl = "+componentedl+" " +
                                    "<br>" +
                        ...
                        if (componentedl.equals("dz")){
                            ...
                            infoM.setText(Html.fromHtml("<b>H</b> = I*r<sup>2</sup>/{2*[r<sup>2</sup> + h<sup>2</sup>]<sup>3/2</sup>} <b>âz</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br> .. dl = "+componentedl+" " +
                                    "<br>" +
