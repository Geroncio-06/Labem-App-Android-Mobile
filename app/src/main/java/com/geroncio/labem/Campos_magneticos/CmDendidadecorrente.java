...
public class CmDendidadecorrente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cm_dendidadecorrente);
    ...
    private void Inicializate() {
        ...
        ajuda.setOnClickListener(view -> {
            ...
            String main = "CmDendidadecorrente.class";
                ...
                try {
                    ...
                    if (processx == null || processy == null || processz == null){
                        ...
                        if (p_1.getText().toString().isEmpty() || p_2.getText().toString().isEmpty()|| p_3.getText().toString().isEmpty()){
                            ...
                            cvSimplify2.setFunctionSimplificar(processarSaidaDerivadaY2);
                            cvSimplify2.simplificar();
                            ...
                            cvSimplify3.setFunctionSimplificar(processarSaidaDerivadaY3);
                            cvSimplify3.simplificar();
                            ...
                            info.setText(Html.fromHtml("<b>J</b> = -[1/m0]*(∇<sup>2</sup>Ax, ∇<sup>2</sup>Ay, ∇<sup>2</sup>Az) " +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>J</b> = -[1/m0]*("+processarSaidaDerivada+" ; "+processarSaidaDerivadaY+" ; "+processarSaidaDerivadaZ+")<b>âx</b> +"+
                                    "<br> -[1/m0]*("+processarSaidaDerivada2+" ; "+processarSaidaDerivadaY2+" ;, "+processarSaidaDerivadaZ2+")<b>ây</b> +"+
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(x,y,z)</b> = "+processx+"<b>âx</b> +" +
                                    ...
                                    "<b>J</b> = -[1/m0]*(∇<sup>2</sup>Ax, ∇<sup>2</sup>Ay, ∇<sup>2</sup>Az)" +
                                    "<br>" +
                                    "<br> m0 é a constante de permeabidade que no vácuo vale: 4π*10<sup>-7</sup> H/m" +
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇<sup>2</sup>Ax = [∂<sup>2</sup>Äx/∂<sup>2</sup>x]<b>âx</b>  +" +
                                    "<br> ..... [∂<sup>2</sup>Äx/∂<sup>2</sup>y]<b>ây</b>  +" +
                                    "<br> ..... [∂<sup>2</sup>Äx/∂<sup>2</sup>z]<b>âz</b>  " +
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇<sup>2</sup>Ay = [∂<sup>2</sup>Äy/∂<sup>2</sup>x]<b>âx</b>  +" +
                                    "<br> ..... [∂<sup>2</sup>Äy/∂<sup>2</sup>y]<b>ây</b>  +" +
                                    "<br> ..... [∂<sup>2</sup>Äy/∂<sup>2</sup>z]<b>âz</b>  " +
                                    "<br>" +
                                    "<br>" +
                                    "<br>∇<sup>2</sup>Az = [∂<sup>2</sup>Äz/∂<sup>2</sup>x]<b>âx</b>  +" +
                                    "<br> ..... [∂<sup>2</sup>Äz/∂<sup>2</sup>y]<b>ây</b>  +" +
                                    ...
                                    "<br> + " +
                                    "<br> ∇<sup>2</sup>Ay = " +
                                    "<br> .. ["+processarSaida2+"]<b>âx</b>" +
                                    "<br> .. ["+processarSaidaY2+"]<b>ây</b>" +
                                    "<br> .. ["+processarSaidaZ2+"]<b>âz</b>" +
                                    "<br> + " +
                                    "<br> ∇<sup>2</sup>Az = " +
                                    "<br> .. ["+processarSaida3+"]<b>âx</b>" +
                                    "<br> .. ["+processarSaidaY3+"]<b>ây</b>" +
                                    "<br> .. ["+processarSaidaZ3+"]<b>âz</b>" +
                                    "<br>" +
                                    "<br>" +
                                    "<br>" +
                                    "<b>J</b> = " +
                                    "<br> -[1/m0]*("+processarSaidaDerivada+" ; "+processarSaidaDerivadaY+" ; "+processarSaidaDerivadaZ+")<b>âx</b> +"+
                                    "<br> -[1/m0]*("+processarSaidaDerivada2+" ; "+processarSaidaDerivadaY2+" ; "+processarSaidaDerivadaZ2+")<b>ây</b> +"+
                                    "<br> -[1/m0]*("+processarSaidaDerivada3+" ; "+processarSaidaDerivadaY3+" ; "+processarSaidaDerivadaZ3+")<b>âz</b> A/m<sup>2</sup>"
                            ));
                            ...
                            info.setText(Html.fromHtml("<b>J</b> = -[1/m0]*(∇<sup>2</sup>Ax, ∇<sup>2</sup>Ay, ∇<sup>2</sup>Az) " +
                                    "<br>" +
                                    "<br>" +
                                    "<br><b>J</b> = ("+df.format(resultx)+" ; "+df.format(resulty)+" ; "+df.format(resultz)+")<b>âx</b> +"+
                                    "<br> ("+df.format(resultx2)+" ; "+df.format(resulty2)+" ; "+df.format(resultz2)+")<b>ây</b> +"+
                            ...
                            infoM.setText(Html.fromHtml("<b>Ä(x,y,z)</b> = "+processx+"<b>âx</b> +" +
                                    ...
                                    "<br>" +
                                    "<b>J</b> = " +
                                    "<br> ("+df.format(resultx)+" ; "+df.format(resulty)+" ; "+df.format(resultz)+")<b>âx</b> +"+
                                    "<br> ("+df.format(resultx2)+" ; "+df.format(resulty2)+" ; "+df.format(resultz2)+")<b>ây</b> +"+
                                    "<br> ("+df.format(resultx3)+" ; "+df.format(resulty3)+" ; "+df.format(resultz3)+")<b>âz</b> A/m<sup>2</sup>"
                            ));
